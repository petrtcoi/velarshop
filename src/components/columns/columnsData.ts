...
const columnsFaqItems = [
	{
		...
		answer:
			'Трубчатые радиаторы дают больше вариантов по высоте, числу секций, подключению и цвету. Панельные чаще выбирают как базовое типовое решение.',
	},
	{
		question: 'Можно ли заказать радиатор в цвет RAL?',
		answer:
			'Да, доступны варианты окраски по шкале RAL. Подбор цвета выполняется под интерьер или требования дизайн-проекта.',
	},
	{
		question: 'Как рассчитать мощность?',
		answer:
			'Нужно учитывать площадь, высоту потолков, теплопотери, температурный график и место установки. Для заказа лучше сделать расчет по помещению.',
	},
	{
		question: 'Сколько длится производство?',
		answer:
			'Срок зависит от модели, цвета и загрузки производства. Менеджер подтвердит дату после согласования конфигурации.',
	},
	{
		question: 'Можно ли установить в квартире?',
		answer:
			'Да, при корректном подборе по рабочему давлению и параметрам системы трубчатые радиаторы подходят для квартир.',
	},
	{
		question: 'Какой тип подключения выбрать?',
		answer: 'Подключение выбирают по разводке труб и месту установки. На странице модели доступны боковые и нижние варианты, а нестандартные решения согласуются отдельно.',
	},
	{
		question: 'Можно ли сделать нестандартный размер?',
		answer: 'Можно подобрать высоту и количество секций под помещение. Если нужен нестандартный проект, отправьте параметры для проверки производства.',
	},
]
...
const columnsHowToSteps = [
	...
	'Подберите высоту и секции',
	'Выберите подключение и цвет',
]
